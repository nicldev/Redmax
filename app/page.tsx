...
import { FileText, CheckCircle2, TrendingUp, Sparkles, BarChart3, Target, Clock, BookOpen } from 'lucide-react'
        ...
        <div className="max-w-notion mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              {
                icon: TrendingUp,
                title: 'Siga seu roadmap até a nota 1000',
                description: 'Plano personalizado de estudos baseado no seu desempenho.',
              },
            ].map((step, index) => (
        ...
        <div className="max-w-notion mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { icon: Target, title: 'Roadmap personalizado', desc: 'Plano de estudos adaptado para você' },
