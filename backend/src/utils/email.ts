...
export async function sendVerificationEmail({
  ...
  const mailOptions = {
    ...
    to: email,
    subject: 'Verifique seu e-mail - RedaIA',
    html: `
      <!DOCTYPE html>
      <html>
        <head>
        ...
        <body>
          <div class="container">
            <h1>Bem-vindo ao RedaIA, ${name}!</h1>
            ...
            <div class="footer">
              <p>Se você não se cadastrou no RedaIA, ignore este e-mail.</p>
            </div>
          </div>
        </body>
      </html>
    ...
    text: `
      ...
      Se você não se cadastrou no RedaIA, ignore este e-mail.
    `,
  }
