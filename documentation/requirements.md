# Requisitos do Sistema - RedaIA

## 1. Introdução

O RedaIA é uma plataforma multiplataforma desenvolvida para auxiliar estudantes na preparação para a redação do ENEM, oferecendo correção automática por IA, acompanhamento de progresso e roadmap personalizado de estudos.
...
#### RF09 - Roadmap de Estudos
- O sistema deve fornecer roadmap personalizado
- O sistema deve sugerir temas de redação
- O sistema deve indicar áreas de melhoria
